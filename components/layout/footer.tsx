      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div>
            ...
            <address className="text-gray-300 not-italic space-y-4">
              <p className="flex items-start">
                ...
                <span>
                  <strong>El Paso, TX:</strong><br />
                  7167 Chino Drive<br />
                  7180 Merchant<br />
                  5850 & 5830 Welch<br />
                  7131 Copper Queen<br /><br />
                  <strong>Santa Teresa, NM:</strong><br />
                  4950 Avenida Creel<br /><br />
                  <strong>Del Rio, TX:</strong><br />
                  195 Frontera Rd<br /><br />
                  <strong>Laredo, TX:</strong><br />
                  8900 San Gabriel Dr
                </span>
              </p>
              <p className="flex items-start">
        ...
        <div className="mt-16 pt-8 border-t border-primary/30 flex flex-col md:flex-row justify-between items-center text-gray-300 text-sm">
          ...
          <div className="mt-4 md:mt-0 flex gap-6">
            ...
            <Link
              href="/admin/login"
              className="opacity-60 hover:opacity-100 transition-opacity hover:text-white"
