  ...
  if (error || !post) {
    return (
      <div className="max-w-4xl mx-auto py-16 px-4 text-center">
        ...
        <Link href="/blog" className="text-primary hover:text-primary/80 font-semibold inline-flex items-center">
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="mt-12 flex justify-center">
            <button 
              ...
              className="bg-primary text-primary-foreground hover:bg-primary/80 px-6 py-3 rounded-md font-semibold inline-flex items-center transition-colors"
            >
